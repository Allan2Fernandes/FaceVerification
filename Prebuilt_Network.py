...
class Prebuilt_Network:
    ...
    def train_the_model(self):
        self.model.fit([self.train_left_array, self.train_right_array], self.train_label_array, epochs=35, shuffle=True,batch_size=8, validation_data = ([self.val_left_array, self.val_right_array], self.val_label_array))
        pass
